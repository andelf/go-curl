...
#if (LIBCURL_VERSION_MINOR == 8 && LIBCURL_VERSION_PATCH < 0) || LIBCURL_VERSION_MINOR < 8 
#define CURLE_ECH_REQUIRED -1
#if (LIBCURL_VERSION_MINOR == 7 && LIBCURL_VERSION_PATCH < 1) || LIBCURL_VERSION_MINOR < 7 
#if (LIBCURL_VERSION_MINOR == 7 && LIBCURL_VERSION_PATCH < 0) || LIBCURL_VERSION_MINOR < 7 
#define CURLINFO_USED_PROXY 0
#if (LIBCURL_VERSION_MINOR == 6 && LIBCURL_VERSION_PATCH < 0) || LIBCURL_VERSION_MINOR < 6 
#define CURLE_TOO_LARGE -1
#define CURLINFO_QUEUE_TIME_T 0
#if (LIBCURL_VERSION_MINOR == 5 && LIBCURL_VERSION_PATCH < 0) || LIBCURL_VERSION_MINOR < 5 
#if (LIBCURL_VERSION_MINOR == 4 && LIBCURL_VERSION_PATCH < 0) || LIBCURL_VERSION_MINOR < 4 
#if (LIBCURL_VERSION_MINOR == 3 && LIBCURL_VERSION_PATCH < 0) || LIBCURL_VERSION_MINOR < 3 
#if (LIBCURL_VERSION_MINOR == 2 && LIBCURL_VERSION_PATCH < 1) || LIBCURL_VERSION_MINOR < 2 
#if (LIBCURL_VERSION_MINOR == 2 && LIBCURL_VERSION_PATCH < 0) || LIBCURL_VERSION_MINOR < 2 
#define CURLOPT_MAIL_RCPT_ALLLOWFAILS 0
#define CURLINFO_XFER_ID 0
#define CURLINFO_CONN_ID 0
#if (LIBCURL_VERSION_MINOR == 1 && LIBCURL_VERSION_PATCH < 2) || LIBCURL_VERSION_MINOR < 1 
#if (LIBCURL_VERSION_MINOR == 1 && LIBCURL_VERSION_PATCH < 1) || LIBCURL_VERSION_MINOR < 1 
#if (LIBCURL_VERSION_MINOR == 1 && LIBCURL_VERSION_PATCH < 0) || LIBCURL_VERSION_MINOR < 1 
