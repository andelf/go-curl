...
#if (LIBCURL_VERSION_MINOR == 9 && LIBCURL_VERSION_PATCH < 8) || LIBCURL_VERSION_MINOR < 9 
#define CURLOPT_CAPATH 0
#if (LIBCURL_VERSION_MINOR == 9 && LIBCURL_VERSION_PATCH < 7) || LIBCURL_VERSION_MINOR < 9 
...
#if (LIBCURL_VERSION_MINOR == 9 && LIBCURL_VERSION_PATCH < 6) || LIBCURL_VERSION_MINOR < 9 
...
#if (LIBCURL_VERSION_MINOR == 9 && LIBCURL_VERSION_PATCH < 5) || LIBCURL_VERSION_MINOR < 9 
#define CURLOPT_PREQUOTE 0
#if (LIBCURL_VERSION_MINOR == 9 && LIBCURL_VERSION_PATCH < 4) || LIBCURL_VERSION_MINOR < 9 
#define CURLINFO_CONTENT_TYPE 0
#if (LIBCURL_VERSION_MINOR == 9 && LIBCURL_VERSION_PATCH < 3) || LIBCURL_VERSION_MINOR < 9 
...
#if (LIBCURL_VERSION_MINOR == 9 && LIBCURL_VERSION_PATCH < 2) || LIBCURL_VERSION_MINOR < 9 
#define CURLOPT_FTP_USE_EPSV 0
#define CURLINFO_STARTTRANSFER_TIME 0
#if (LIBCURL_VERSION_MINOR == 9 && LIBCURL_VERSION_PATCH < 1) || LIBCURL_VERSION_MINOR < 9 
#define CURLOPT_COOKIEJAR 0
#define CURLOPT_SSL_CIPHER_LIST 0
#define CURLOPT_HTTP_VERSION 0
#define CURLE_GOT_NOTHING -1
#if (LIBCURL_VERSION_MINOR == 8 && LIBCURL_VERSION_PATCH < 1) || LIBCURL_VERSION_MINOR < 8 
#define CURLOPT_HTTPGET 0
#define CURLOPT_SSL_VERIFYHOST 0
#define CURLE_OBSOLETE -1
#define CURLE_SSL_PEER_CERTIFICATE -1
#if (LIBCURL_VERSION_MINOR == 7 && LIBCURL_VERSION_PATCH < 3) || LIBCURL_VERSION_MINOR < 7 
#if (LIBCURL_VERSION_MINOR == 7 && LIBCURL_VERSION_PATCH < 2) || LIBCURL_VERSION_MINOR < 7 
#define CURLOPT_HEADERFUNCTION 0
#define CURLE_ALREADY_COMPLETE -1
#if (LIBCURL_VERSION_MINOR == 7 && LIBCURL_VERSION_PATCH < 1) || LIBCURL_VERSION_MINOR < 7 
...
#if (LIBCURL_VERSION_MINOR == 6 && LIBCURL_VERSION_PATCH < 1) || LIBCURL_VERSION_MINOR < 6 
#define CURLINFO_CONTENT_LENGTH_DOWNLOAD 0
#define CURLINFO_CONTENT_LENGTH_UPLOAD 0
#if (LIBCURL_VERSION_MINOR == 5 && LIBCURL_VERSION_PATCH < 2) || LIBCURL_VERSION_MINOR < 5 
...
#if (LIBCURL_VERSION_MINOR == 4 && LIBCURL_VERSION_PATCH < 1) || LIBCURL_VERSION_MINOR < 4 
...
#define CURLINFO_LASTONE 0
#if (LIBCURL_VERSION_MINOR == 1 && LIBCURL_VERSION_PATCH < 1) || LIBCURL_VERSION_MINOR < 1 
